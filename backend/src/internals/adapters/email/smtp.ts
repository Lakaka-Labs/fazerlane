import type {EmailRepository} from "../../domain/email/repository";
import {type EmailParameters, EmailType} from "../../domain/email/email";
import * as nodemailer from 'nodemailer';
import type {SMTPCredentials} from "../../../packages/secret";
