        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="420" style="max-width: 420px; background-color: #ffffff; border: 1px solid #ebebeb; border-radius: 10px;">
          <tr>
            <td style="padding: 40px 32px; text-align: center;">
              ...
              <!-- Title -->
              <h1 style="font-size: 24px; font-weight: bold; margin: 0 0 12px 0; color: #0d0d0d; line-height: 1.3; font-family: Arial, Helvetica, sans-serif;">Reset your password</h1>
              
              <!-- Text -->
              <p style="font-size: 16px; line-height: 1.5; margin: 0 0 24px 0; color: #8e8e8e; font-family: Arial, Helvetica, sans-serif;">We received a request to reset your password. Click the button below to choose a new one.</p>
