...
const ReferencesDropdown = ({
    ...
    return (
        <div>
            ...
            >
                <div className="flex items-start w-full cursor-pointer gap-2 px-4 py-6">
                    <Image src={"/icons/yt.svg"} alt={"youtube icon"} height={20} width={20} className="text-primary my-0.5"/>
            ...
            <AnimatePresence mode="wait">
                {isOpen && videoLink && (
                    ...
                    >
                        ...
                        <div
                            className="font-lato mt-3 flex w-full items-center justify-center gap-2 text-center font-semibold">
