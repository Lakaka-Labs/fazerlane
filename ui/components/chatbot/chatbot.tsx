...
const Chatbot: React.FC = () => {
  ...
  return (
    <div>
      <div
        onClick={handleClose}
        className="bg-brand-black/70 fixed top-0 left-0 z-10 h-screen w-screen"
      />

      <div className="fixed top-[70px] left-1/2 z-20 -translate-x-1/2">
        <div className="animate-gradient shadow-brand-black relative z-20 h-fit w-fit rounded-md bg-gradient-to-r from-[#3AE7CA] via-[#357FEE] to-[#EE0672] bg-[length:200%_200%] p-0.5 shadow-2xl backdrop-blur-md">
          <div className="flex w-md rounded-md bg-white">
            <Input
              ref={inputRef}
              type={"text"}
